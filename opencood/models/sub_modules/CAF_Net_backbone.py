...
from opencood.models.fuse_modules.Collaborative_Attention_Fuse import CollaborativeAttentionFusion
from opencood.models.sub_modules.auto_encoder import AutoEncoder

DEBUG = False

class CAFNetBackbone(nn.Module):
    def __init__(self, model_cfg, input_channels):
        ...
        for idx in range(num_levels):
            ...
            fuse_network = CollaborativeAttentionFusion(num_filters[idx])
