...
from opencood.models.fuse_modules.fusion_in_one import CollaborativeAttentionFusion
from opencood.models.sub_modules.CAF_Net_backbone import CAFNetBackbone
from opencood.models.sub_modules.att_bev_backbone import AttBEVBackbone

class PointPillarMKDCooper(nn.Module):
    def __init__(self, args):
        super(PointPillarMKDCooper, self).__init__()
        ...
        self.backbone = CAFNetBackbone(args['base_bev_backbone'], 64)
        ...
        self.fusion_net = CollaborativeAttentionFusion(self.out_channel)
